...
export default class HistoryPlayer {
    ...
    */
     ...
     */
    showDown(playerCards: {[playerId: string]: CardGroup},playerWins: {[playerId: string]: number}):any{
    ...
    private setGame(hasStart = false)
    {
        ...
        this._dealer = new Dealer(this._history.rule)
    ...
    private getBoardCardGroup (): CardGroup
    {
        let cards = [];
        ...
        return CardGroup.fromCards(cards) 
    }
    //#endregion
