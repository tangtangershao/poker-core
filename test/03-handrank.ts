...
import { CardGroup, FullDeckRule, HandRank, Rank } from '../src/index'

describe('HandRank', () => {
  it('detects royal flush', () => {
    const rules: FullDeckRule = new FullDeckRule()
  ...
  it('detects high card', () => {
    ...
    const handrank: HandRank = HandRank.evaluate(rules, hand.concat(board) as CardGroup)
